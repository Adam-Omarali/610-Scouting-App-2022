...
function Home(props){
    ...
    return(
        <div className="App-header">
            ...
            <div className="padding-top">
                    <TextField placeholder="Match Number" label="Match Number" value={matchNumber} onChange={(e) => {setMatchNumber(e.target.value)}}>Match Number</TextField>
            </div>
            <div className='padding-top'>
                <Button variant="contained" onClick={() => changePage()}>Start Match</Button>
            </div>
            <div className='padding-top'>
